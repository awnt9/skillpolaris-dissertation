...
| 2 | `agent_context/*` | Session start; required in `/research` and `/write` | `STATUS.md`, `OUTLINE.md` via `/update_status`; `PROJECT.md` / `DESIGN.md` when vision or design changes (user-approved) |
